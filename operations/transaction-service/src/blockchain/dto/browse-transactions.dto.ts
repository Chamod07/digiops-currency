...
import { IsOptional, IsDateString, IsNumber, Min, IsEthereumAddress, Matches } from '@nestjs/class-validator';
...
export class BrowseTransactionsDto {
  ...
  @ApiPropertyOptional({ description: 'Maximum number of results to return. Defaults to 10.', default: 10 })
  @IsOptional()
  @IsNumber()
  @Min(1)
